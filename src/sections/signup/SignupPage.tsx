...
export default function SignupPage() {
  ...
  async function onSubmit(values: FormValues) {
    ...
    try {
      ...
      if (!res.ok) {
        const message =
          (data && data.message) || `Signup failed (${res.status})`;
      ...
      >
        <div className="text-sm">
          ...
          <input
            ...
            className={`${inputBase} ${
              errors.name ? errorClass : "border-transparent shadow-sm"
            }`}
        ...
        <div className="text-sm">
          ...
          <input
            ...
            className={`${inputBase} ${
              errors.email ? errorClass : "border-transparent shadow-sm"
            }`}
        ...
        <div className="text-sm relative">
          ...
          <input
            ...
            className={`${inputBase} ${
              errors.password ? errorClass : "border-transparent shadow-sm"
            }`}
        ...
        <div className="text-sm relative">
          ...
          <input
            ...
            className={`${inputBase} ${
              errors.confirm ? errorClass : "border-transparent shadow-sm"
            }`}
