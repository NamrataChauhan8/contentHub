        ...
        <div className='absolute inset-0 flex items-center justify-center px-6'>
          <div className='text-center'>
            ...
            <p className='mt-3 text-white/90 text-sm sm:text-base max-w-2xl mx-auto'>
              Create your own blog with us in a few clicks. Fill the form below to create your blog.
            </p>
          </div>
        </div>
      </section>
        ...
        <form onSubmit={handleSubmit} className='space-y-6'>
          ...
          <div className='flex justify-end gap-4'>
            ...
            <button
              ...
              className='cursor-pointer px-6 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors flex items-center gap-2'
            >
