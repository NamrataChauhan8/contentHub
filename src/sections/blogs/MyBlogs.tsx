        ...
        <div className='relative rounded-none sm:rounded-md overflow-hidden bg-gradient-to-r from-[#1e3a8a] to-[#1e3a8a]/30 h-48 sm:h-56 md:h-64 lg:h-72 flex items-center'>
          <div className='w-full px-4 sm:px-8'>
            <div className='text-center'>
              <h1 className='text-white text-2xl sm:text-3xl md:text-4xl font-semibold tracking-tight'>My Blogs</h1>
          ...
          <>
            ...
            >
              {paginated?.map(blog => (
                <div
                  key={blog.id}
                  className='flex flex-col justify-between p-4 sm:p-5 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-sm hover:shadow-md transition-shadow min-h-[180px]'
                >
                  <div className='mb-3'>
